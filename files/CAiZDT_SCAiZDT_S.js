import{ai as e,aj as t,t as i,ar as a,ax as o,au as r}from"./lucifer.v7.js";import{I as s,F as n,D as c,x as l,M as w,S as d,R as p,z as u,a as m,v as h,r as v,C as g,d as f,c as b,h as y,E as x,O as k,f as C,A as S,l as R,b as N,T,w as A,k as W,i as $}from"./CV2aYgNvCV2aYgNv.js";import{c as E,U as I}from"./BstBkq0kBstBkq0k.js";import"./WASpYwqKWASpYwqK.js";const O=l({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),P=s({state:O,subscribe:e=>c(O,()=>e(O)),subscribeKey:(e,t)=>n(O,e,t),showTooltip({message:e,triggerRect:t,variant:i}){O.open=!0,O.message=e,O.triggerRect=t,O.variant=i},hide(){O.open=!1,O.message="",O.triggerRect={width:0,height:0,top:0,left:0}}}),j={isUnsupportedChainView:()=>"UnsupportedChain"===p.state.view||"SwitchNetwork"===p.state.view&&p.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void w.shake();await d.isSIWXCloseDisabled()?w.shake():w.close()}},B=e`
  :host {
    display: block;
...
`;let z=class extends t{render(){return i`<slot></slot>`}};z.styles=[u,B],z=function(e,t,i,a){var o,r=arguments.length,s=r<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s}([E("wui-card")],z);const L=e`
  :host {
    display: flex;
    align-items: center;
...
`;var D=function(e,t,i,a){var o,r=arguments.length,s=r<3?t:a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let U=class extends t{constructor(){super(...arguments),this.message="",this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="info"}render(){return this.style.cssText=`\n      --local-icon-bg-value: var(--wui-color-${this.backgroundColor});\n   `,i`
    ...
    `}onClose(){m.close()}};U.styles=[u,L],D([a()],U.prototype,"message",void 0),D([a()],U.prototype,"backgroundColor",void 0),D([a()],U.prototype,"iconColor",void 0),D([a()],U.prototype,"icon",void 0),U=D([E("wui-alertbar")],U);const H=e`
  :host {
    display: block;
    position: absolute;
...
`;var K=function(e,t,i,a){var o,r=arguments.length,s=r<3?t:a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};const V={info:{backgroundColor:"fg-350",iconColor:"fg-325",icon:"info"},success:{backgroundColor:"success-glass-reown-020",iconColor:"success-125",icon:"checkmark"},warning:{backgroundColor:"warning-glass-reown-020",iconColor:"warning-100",icon:"warningCircle"},error:{backgroundColor:"error-glass-reown-020",iconColor:"error-125",icon:"exclamationTriangle"}};let X=class extends t{constructor(){super(),this.unsubscribe=[],this.open=m.state.open,this.onOpen(!0),this.unsubscribe.push(m.subscribeKey("open",e=>{this.open=e,this.onOpen(!1)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{message:e,variant:t}=m.state,a=V[t];return i`
      <wui-alertbar
        message=${e}
        ...
        icon=${a?.icon}
      ></wui-alertbar>
    `}onOpen(e){this.open?(this.animate([{opacity:0,transform:"scale(0.85)"},{opacity:1,transform:"scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.style.cssText="pointer-events: auto"):e||(this.animate([{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"}),this.style.cssText="pointer-events: none")}};X.styles=H,K([o()],X.prototype,"open",void 0),X=K([E("w3m-alertbar")],X);const Y=e`
  button {
...
`;var M=function(e,t,i,a){var o,r=arguments.length,s=r<3?t:a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let _=class extends t{constructor(){super(...arguments),this.size="md",this.disabled=!1,this.icon="copy",this.iconColor="inherit"}render(){const e="lg"===this.size?"--wui-border-radius-xs":"--wui-border-radius-xxs",t="lg"===this.size?"--wui-spacing-1xs":"--wui-spacing-2xs";return this.style.cssText=`\n    --local-border-radius: var(${e});\n    --local-padding: var(${t});\n`,i`
      <button ?disabled=${this.disabled}>
        <wui-icon color=${this.iconColor} size=${this.size} name=${this.icon}></wui-icon>
      </button>
    `}};_.styles=[u,h,v,Y],M([a()],_.prototype,"size",void 0),M([a({type:Boolean})],_.prototype,"disabled",void 0),M([a()],_.prototype,"icon",void 0),M([a()],_.prototype,"iconColor",void 0),_=M([E("wui-icon-link")],_);const G=e`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var q=function(e,t,i,a){var o,r=arguments.length,s=r<3?t:a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let F=class extends t{constructor(){super(...arguments),this.imageSrc=""}render(){return i`<button>
      ${this.imageTemplate()}
    ...
    ></wui-icon-box>`}};F.styles=[u,h,v,G],q([a()],F.prototype,"imageSrc",void 0),F=q([E("wui-select")],F);const J=e`
  :host {
    height: 64px;
  }
...
`;var Q=function(e,t,i,a){var o,r=arguments.length,s=r<3?t:a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};const Z=["SmartSessionList"];function ee(){const e=p.state.data?.connector?.name,t=p.state.data?.wallet?.name,i=p.state.data?.network?.name,a=t??e,o=C.getConnectors();return{Connect:`Connect ${1===o.length&&"w3m-email"===o[0]?.id?"Email":""} Wallet`,Create:"Create Wallet",ChooseAccountName:void 0,Account:void 0,AccountSettings:void 0,AllWallets:"All Wallets",ApproveTransaction:"Approve Transaction",BuyInProgress:"Buy",ConnectingExternal:a??"Connect Wallet",ConnectingWalletConnect:a??"WalletConnect",ConnectingWalletConnectBasic:"WalletConnect",ConnectingSiwe:"Sign In",Convert:"Convert",ConvertSelectToken:"Select token",ConvertPreview:"Preview convert",Downloads:a?`Get ${a}`:"Downloads",EmailLogin:"Email Login",EmailVerifyOtp:"Confirm Email",EmailVerifyDevice:"Register Device",GetWallet:"Get a wallet",Networks:"Choose Network",OnRampProviders:"Choose Provider",OnRampActivity:"Activity",OnRampTokenSelect:"Select Token",OnRampFiatSelect:"Select Currency",Pay:"How you pay",Profile:void 0,SwitchNetwork:i??"Switch Network",SwitchAddress:"Switch Address",Transactions:"Activity",UnsupportedChain:"Switch Network",UpgradeEmailWallet:"Upgrade your Wallet",UpdateEmailWallet:"Edit Email",UpdateEmailPrimaryOtp:"Confirm Current Email",UpdateEmailSecondaryOtp:"Confirm New Email",WhatIsABuy:"What is Buy?",RegisterAccountName:"Choose name",RegisterAccountNameSuccess:"",WalletReceive:"Receive",WalletCompatibleNetworks:"Compatible Networks",Swap:"Swap",SwapSelectToken:"Select token",SwapPreview:"Preview swap",WalletSend:"Send",WalletSendPreview:"Review send",WalletSendSelectToken:"Select Token",WhatIsANetwork:"What is a network?",WhatIsAWallet:"What is a wallet?",ConnectWallets:"Connect wallet",ConnectSocials:"All socials",ConnectingSocial:S.state.socialProvider?S.state.socialProvider:"Connect Social",ConnectingMultiChain:"Select chain",ConnectingFarcaster:"Farcaster",SwitchActiveChain:"Switch chain",SmartSessionCreated:void 0,SmartSessionList:"Smart Sessions",SIWXSignMessage:"Sign In",PayLoading:"Payment in progress"}}let te=class extends t{constructor(){super(),this.unsubscribe=[],this.heading=ee()[p.state.view],this.network=g.state.activeCaipNetwork,this.networkImage=f.getNetworkImage(this.network),this.showBack=!1,this.prevHistoryLength=1,this.view=p.state.view,this.viewDirection="",this.headerText=ee()[p.state.view],this.unsubscribe.push(b.subscribeNetworkImages(()=>{this.networkImage=f.getNetworkImage(this.network)}),p.subscribeKey("view",e=>{setTimeout(()=>{this.view=e,this.headerText=ee()[e]},y.ANIMATION_DURATIONS.HeaderText),this.onViewChange(),this.onHistoryChange()}),g.subscribeKey("activeCaipNetwork",e=>{this.network=e,this.networkImage=f.getNetworkImage(this.network)}))}disconnectCallback(){this.unsubscribe.forEach(e=>e())}render(){return i`
    ...
    `}leftHeaderTemplate(){const{view:e}=p.state,t="Connect"===e,a=k.state.enableEmbedded,o="ApproveTransaction"===e,s="ConnectingSiwe"===e,n="Account"===e,c=k.state.enableNetworkSwitch,l=o||s||t&&a;return n&&c?i`<wui-select
        id="dynamic"
...
`;var ae=function(e,t,i,a){var o,r=arguments.length,s=r<3?t:a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let oe=class extends t{constructor(){super(...arguments),this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="checkmark",this.message="",this.loading=!1,this.iconType="default"}render(){return i`
      ${this.templateIcon()}
    ...
    `}templateIcon(){return this.loading?i`<wui-loading-spinner size="md" color="accent-100"></wui-loading-spinner>`:"default"===this.iconType?i`<wui-icon size="xl" color=${this.iconColor} name=${this.icon}></wui-icon>`:i`<wui-icon-box
      ...
      icon=${this.icon}
      background="opaque"
    ></wui-icon-box>`}};oe.styles=[u,ie],ae([a()],oe.prototype,"backgroundColor",void 0),ae([a()],oe.prototype,"iconColor",void 0),ae([a()],oe.prototype,"icon",void 0),ae([a()],oe.prototype,"message",void 0),ae([a()],oe.prototype,"loading",void 0),ae([a()],oe.prototype,"iconType",void 0),oe=ae([E("wui-snackbar")],oe);const re=e`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
...
`;var se=function(e,t,i,a){var o,r=arguments.length,s=r<3?t:a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};const ne={loading:void 0,success:{backgroundColor:"success-100",iconColor:"success-100",icon:"checkmark"},error:{backgroundColor:"error-100",iconColor:"error-100",icon:"close"}};let ce=class extends t{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=R.state.open,this.unsubscribe.push(R.subscribeKey("open",e=>{this.open=e,this.onOpen()}))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach(e=>e())}render(){const{message:e,variant:t,svg:a}=R.state,o=ne[t],{icon:r,iconColor:s}=a??o??{};return i`
      <wui-snackbar
        message=${e}
        ...
        .loading=${"loading"===t}
      ></wui-snackbar>
    `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:"translateX(-50%) scale(0.85)"},{opacity:1,transform:"translateX(-50%) scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.timeout&&clearTimeout(this.timeout),R.state.autoClose&&(this.timeout=setTimeout(()=>R.hide(),2500))):this.animate([{opacity:1,transform:"translateX(-50%) scale(1)"},{opacity:0,transform:"translateX(-50%) scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"})}};ce.styles=re,se([o()],ce.prototype,"open",void 0),ce=se([E("w3m-snackbar")],ce);const le=e`
  :host {
    pointer-events: none;
  }
...
`;var we=function(e,t,i,a){var o,r=arguments.length,s=r<3?t:a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let de=class extends t{constructor(){super(),this.unsubscribe=[],this.open=P.state.open,this.message=P.state.message,this.triggerRect=P.state.triggerRect,this.variant=P.state.variant,this.unsubscribe.push(P.subscribe(e=>{this.open=e.open,this.message=e.message,this.triggerRect=e.triggerRect,this.variant=e.variant}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){this.dataset.variant=this.variant;const e=this.triggerRect.top,t=this.triggerRect.left;return this.style.cssText=`\n    --w3m-tooltip-top: ${e}px;\n    --w3m-tooltip-left: ${t}px;\n    --w3m-tooltip-parent-width: ${this.triggerRect.width/2}px;\n    --w3m-tooltip-display: ${this.open?"flex":"none"};\n    --w3m-tooltip-opacity: ${this.open?1:0};\n    `,i`<wui-flex>
      <wui-icon data-placement="top" color="fg-100" size="inherit" name="cursor"></wui-icon>
      <wui-text color="inherit" variant="small-500">${this.message}</wui-text>
    </wui-flex>`}};de.styles=[le],we([o()],de.prototype,"open",void 0),we([o()],de.prototype,"message",void 0),we([o()],de.prototype,"triggerRect",void 0),we([o()],de.prototype,"variant",void 0),de=we([E("w3m-tooltip"),E("w3m-tooltip")],de);const pe=e`
  :host {
    --prev-height: 0px;
    --new-height: 0px;
    display: block;
...
`;var ve=function(e,t,i,a){var o,r=arguments.length,s=r<3?t:a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};const ge="scroll-lock";class fe extends t{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.hasPrefetched=!1,this.enableEmbedded=k.state.enableEmbedded,this.open=w.state.open,this.caipAddress=g.state.activeCaipAddress,this.caipNetwork=g.state.activeCaipNetwork,this.shake=w.state.shake,this.filterByNamespace=C.state.filterByNamespace,this.initializeTheming(),N.prefetchAnalyticsConfig(),this.unsubscribe.push(w.subscribeKey("open",e=>e?this.onOpen():this.onClose()),w.subscribeKey("shake",e=>this.shake=e),g.subscribeKey("activeCaipNetwork",e=>this.onNewNetwork(e)),g.subscribeKey("activeCaipAddress",e=>this.onNewAddress(e)),k.subscribeKey("enableEmbedded",e=>this.enableEmbedded=e),C.subscribeKey("filterByNamespace",e=>{this.filterByNamespace===e||g.getAccountData(e)?.caipAddress||(N.fetchRecommendedWallets(),this.filterByNamespace=e)}))}firstUpdated(){if(this.caipAddress){if(this.enableEmbedded)return w.close(),void this.prefetch();this.onNewAddress(this.caipAddress)}this.open&&this.onOpen(),this.enableEmbedded&&this.prefetch()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.style.cssText=`\n      --local-border-bottom-mobile-radius: ${this.enableEmbedded?"clamp(0px, var(--wui-border-radius-l), 44px)":"0px"};\n    `,this.enableEmbedded?i`${this.contentTemplate()}
    ...
    </wui-card>`}async onOverlayClick(e){e.target===e.currentTarget&&await this.handleClose()}async handleClose(){await j.safeClose()}initializeTheming(){const{themeVariables:e,themeMode:t}=T.state,i=I.getColorTheme(t);A(e,i)}onClose(){this.open=!1,this.classList.remove("open"),this.onScrollUnlock(),R.hide(),this.onRemoveKeyboardListener()}onOpen(){this.open=!0,this.classList.add("open"),this.onScrollLock(),this.onAddKeyboardListener()}onScrollLock(){const e=document.createElement("style");e.dataset.w3m=ge,e.textContent="\n      body {\n        touch-action: none;\n        overflow: hidden;\n        overscroll-behavior: contain;\n      }\n      w3m-modal {\n        pointer-events: auto;\n      }\n    ",document.head.appendChild(e)}onScrollUnlock(){const e=document.head.querySelector(`style[data-w3m="${ge}"]`);e&&e.remove()}onAddKeyboardListener(){this.abortController=new AbortController;const e=this.shadowRoot?.querySelector("wui-card");e?.focus(),window.addEventListener("keydown",t=>{if("Escape"===t.key)this.handleClose();else if("Tab"===t.key){const{tagName:i}=t.target;!i||i.includes("W3M-")||i.includes("WUI-")||e?.focus()}},this.abortController)}onRemoveKeyboardListener(){this.abortController?.abort(),this.abortController=void 0}async onNewAddress(e){const t=g.state.isSwitchingNamespace,i=W.getPlainAddress(e),a=t&&i;!i&&!t?w.close():a&&p.goBack(),await d.initializeIfEnabled(),this.caipAddress=e,g.setIsSwitchingNamespace(!1)}onNewNetwork(e){const t=this.caipNetwork,i=t?.caipNetworkId?.toString(),a=t?.chainNamespace,o=e?.caipNetworkId?.toString(),r=e?.chainNamespace,s=i!==o,n=s&&!(a!==r),c=t?.name===$.UNSUPPORTED_NETWORK_NAME,l="ConnectingExternal"===p.state.view,d=!g.getAccountData(e?.chainNamespace)?.caipAddress,u="UnsupportedChain"===p.state.view;let m=!1;w.state.open&&!l&&(d?s&&(m=!0):(u||n&&!c)&&(m=!0)),m&&"SIWXSignMessage"!==p.state.view&&p.goBack(),this.caipNetwork=e}prefetch(){this.hasPrefetched||(N.prefetch(),N.fetchWalletsByPage({page:1}),this.hasPrefetched=!0)}}fe.styles=he,ve([a({type:Boolean})],fe.prototype,"enableEmbedded",void 0),ve([o()],fe.prototype,"open",void 0),ve([o()],fe.prototype,"caipAddress",void 0),ve([o()],fe.prototype,"caipNetwork",void 0),ve([o()],fe.prototype,"shake",void 0),ve([o()],fe.prototype,"filterByNamespace",void 0);let be=class extends fe{};be=ve([E("w3m-modal")],be);let ye=class extends fe{};ye=ve([E("appkit-modal")],ye);export{ye as AppKitModal,be as W3mModal,fe as W3mModalBase};
